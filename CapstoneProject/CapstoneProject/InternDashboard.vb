...
Public Class InternDashboard
    Shared Property IntDashboard As String
    Private Sub InternDashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Refresh()
        Label2.Text = IntDashboard
